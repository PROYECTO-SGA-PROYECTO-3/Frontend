...
export function MateriaFila({
  ...
  return (
    <tr className="group transition-colors duration-150 hover:bg-slate-50/80">
      {/* Posición secuencial */}
      <td className="px-6 py-4 text-center font-mono text-xs font-medium text-slate-400">
        {indice + 1}
      </td>
      ...
      <td className="px-6 py-4 text-right">
        <div className="flex items-center justify-end gap-1">
          ...
          <button
            ...
            className="cursor-pointer rounded-lg p-2 text-slate-400 transition-colors hover:bg-red-50 hover:text-red-600 focus:outline-hidden focus:ring-2 focus:ring-red-500/20"
          >
            <Trash2 size={16} />
          </button>
        </div>
